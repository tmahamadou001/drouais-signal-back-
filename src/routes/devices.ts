...
/*
 * Les préférences ont quitté ce fichier.
 *
 * La 023 les posait sur `device_tokens`, ce qui était juste tant que le push
 * était le seul canal. L'e-mail n'a pas d'appareil : un citoyen qui n'a jamais
 * accordé les notifications n'a aucune ligne ici, donc aucun endroit où
 * refuser les e-mails. Elles vivent désormais sur le compte —
